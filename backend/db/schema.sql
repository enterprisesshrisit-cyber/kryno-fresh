...
create table if not exists user_profiles (
  ...
  posts_visibility varchar(16) not null default 'public',
  message_visibility varchar(16) not null default 'public',
  created_at timestamptz not null default now(),
  updated_at timestamptz not null default now(),
  constraint user_profiles_visibility_check check (profile_visibility in ('public', 'followers')),
  constraint user_profiles_posts_visibility_check check (posts_visibility in ('public', 'followers')),
  constraint user_profiles_message_visibility_check check (message_visibility in ('public', 'followers', 'none'))
);
