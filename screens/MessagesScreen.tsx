        ...
        >
          ...
          <View style={styles.modalHero}>
            ...
            <View style={styles.modalUserInfo}>
              ...
              <Text style={styles.modalHandle}>{user.handle}</Text>
...
function ConversationRow({ convo, onAvatarPress, onPress }: { convo: typeof CONVERSATIONS[0]; onAvatarPress: () => void; onPress: () => void }) {
  ...
  const tierCfg = TIER[convo.user.tier];
  const moodCfg = MOOD[convo.user.mood];
...
const styles = StyleSheet.create({
  ...
  modalHandle: { fontSize: FONTS.sm, color: COLORS.textMuted },
