...
export default function ProfileScreen() {
  const [status, setStatus] = useState<StatusType>(ME.status);
  const [mood, setMood] = useState<MoodType>(ME.mood);
  ...
  const leftPosts = PROFILE_POSTS.filter((_, i) => i % 2 === 0);
  const rightPosts = PROFILE_POSTS.filter((_, i) => i % 2 !== 0);
    ...
    <View style={[styles.root, { backgroundColor: COLORS.bg }]}>
      ...
      >
          ...
          <View style={styles.avatarSection}>
            ...
            <View style={styles.verifiedBadge}>
              <LinearGradient colors={tierCfg.colors as any} style={styles.verifiedGrad}>
                <Text style={styles.verifiedIcon}>{tierCfg.icon}</Text>
              </LinearGradient>
            </View>
          </View>
        ...
        <View style={styles.sections}>
          ...
          <MemberCard tier={ME.tier} joinDate={ME.joinDate} />

          {/* Stats */}
          <GlassCard style={styles.statsCard}>
            <StatItem label="Posts" value={ME.stats.posts} />
            <View style={styles.statDivider} />
            <StatItem label="Followers" value={ME.stats.followers} />
            <View style={styles.statDivider} />
            <StatItem label="Following" value={ME.stats.following} />
            <View style={styles.statDivider} />
            <View style={styles.statItem}>
              <Text style={styles.statValue}>👀 {ME.stats.visits}</Text>
          ...
          <View>
            ...
            <MiniMusicBar title={ME.music.title} artist={ME.music.artist} progress={ME.music.progress} />
          </View>
          ...
          <View>
            <View style={styles.rowHeader}>
              ...
              <TouchableOpacity style={styles.gridToggleBtn}>
